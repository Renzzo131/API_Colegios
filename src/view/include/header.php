...
<head>
    <meta charset="utf-8" />
    <title>SISTEMA DE CENTROS EDUCATIVOS</title>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-components">
                                        ...
                                        <a href="<?php echo BASE_URL ?>api-token" class="dropdown-item">Tokens API</a>
                                        <a href="<?php echo BASE_URL ?>api-request" class="dropdown-item">Request</a>
                                    </div>
                                </li>
